            ...
            <tr>
                ...
                <td class="text-center">
                    ...
                    @if ($student->image == null)
                        <img src="{{ Storage::url('public/students/default.png')}}" class="rounded" style="object-fit: cover; width: 60px; height: 60px;">
                    @else
                        <img src="{{ Storage::url('public/students/') . $student->image }}" class="rounded" style="object-fit: cover; width: 60px; height: 60px;">
                    @endif
                </td>
                    ...
                    <div class="modal-body text-start">
                        <div class="row">
                            <div class="col-md-4">
                                {{-- Jika image tidak ada, maka tampilkan gambar default --}}
                                @if ($student->image == null)
                                    <img src="{{ Storage::url('public/students/default.png')}}" class="rounded" style="object-fit: cover; width: 150px; height: 200px;">
                                @else
                                    <img src="{{ Storage::url('public/students/') . $student->image }}" class="rounded" style="object-fit: cover; width: 150px; height: 200px;">
                                @endif
                            </div>
                            <div class="col-md-8">
